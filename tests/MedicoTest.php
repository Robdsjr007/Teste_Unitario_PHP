<?php
    ...
    class MedicoTest extends TestCase{
        ...
        public function testMedicoTelefone(){
            $p3 = new Medico(1, "Rogério", 11991134786, "Rua carlos almeida, 53", new Especialidade(1, "Rogério", "Nerd"));
            
            $this->assertEquals(11991134786, $p3->getTelefone());
        }

        public function testMedicoEndereco(){
            $p4 = new Medico(1, "Rogério", 11991134786, "Rua carlos almeida, 53", new Especialidade(1, "Rogério", "Nerd"));
